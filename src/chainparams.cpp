...
public:
    CMainParams() {
        ...
        consensus.nPowTargetTimespan = 2016 * 512; // ~12 days
        consensus.nPowTargetSpacing = 512; // block interval in seconds
        ...
        genesis = CreateGenesisBlock(1231006505, 2083236893, 0x1d00ffff, 1, 200 * COIN);
...
#if 0
        // TODO add Abelian seeders
        vSeeds.emplace_back("seed.abelian.xxx.xxx");
#endif
...
#if 0
        // TODO add Abelian testnet seeders
        vSeeds.emplace_back("seed.testnet.abelian.xxx.xxx");
#endif
